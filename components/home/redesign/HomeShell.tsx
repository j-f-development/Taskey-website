...
const HERO_CONTENT: Record<Lang, {
  ...
  de: {
    ...
    lead: "Die Gebäudereinigungssoftware, die Ihren Betrieb zusammenhält. Objekte, Personal, NFC-Zeiterfassung, Kalkulation und Ausschreibungen auf einer Plattform, gebaut für Reinigungsbetriebe im DACH-Raum. Weniger Tools. Weniger Aufwand. Mehr Marge, direkt vom Handy.",
  ...
  en: {
    ...
    lead: "The cleaning management software that holds your operation together. Sites, workforce, NFC time tracking, calculation and tenders on one platform, built for cleaning operations in the DACH region. Fewer tools. Less overhead. More margin, straight from your phone.",
  ...
  fr: {
    ...
    lead: "Le logiciel de gestion de nettoyage qui garde votre entreprise unie. Sites, équipes, pointage NFC, calcul et appels d’offres sur une plateforme, conçue pour les entreprises de nettoyage dans la région DACH. Moins d’outils. Moins de charge. Plus de marge, directement depuis le téléphone.",
