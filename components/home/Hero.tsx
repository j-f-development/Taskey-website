      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid md:grid-cols-2 gap-8 sm:gap-12 items-center">
          <div className="relative order-2 md:order-1">
            {/* NFC Badge */}
            <div className="inline-flex items-center gap-2 bg-blue-50 border border-blue-200 text-blue-900 px-4 py-2 rounded-full text-sm font-bold mb-4">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-4 sm:mb-6 leading-tight">
              Die Baustelle, die mit dir spricht
            </h1>
            <p className="text-base sm:text-lg md:text-xl text-gray-600 mb-4">
              <span className="font-bold text-blue-900">Kleben. Scannen. Wissen.</span> Gib deinem Betrieb ein digitales Gedächtnis mit NFC-Tags. Jede Maschine, jede Anlage wird smart.
            </p>
            <p className="text-sm sm:text-base text-gray-500 mb-6 sm:mb-8">
              Plus: Automatische Zeiterfassung, intelligente Auftragsplanung für über 600 Branchen. Made in Germany, DSGVO-konform.
            </p>
