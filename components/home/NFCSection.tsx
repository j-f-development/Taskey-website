    ...
    <section className="py-20 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div className="relative">
            <div className="bg-white/5 backdrop-blur-sm rounded-3xl p-8 border border-white/10">
              <div className="bg-gradient-to-br from-cyan-400/20 to-blue-500/20 rounded-2xl p-12 text-center">
                ...
                <div className="text-white text-lg font-bold mb-2">Taskey NFC-Tag</div>
                <div className="text-cyan-300 text-sm">Einfach aufkleben & scannen</div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10 hover:bg-white/10 transition-all">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-white font-bold text-lg mb-2">Digitale Anlagenakte</h3>
                  <p className="text-gray-400 text-sm">
                    Schaltpläne, Wartungsprotokolle, Fotos — alles direkt am Objekt abrufbar. Ein Scan und du siehst die komplette Historie.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 pt-12 border-t border-white/10">
          ...
          <div className="text-center">
            <div className="text-3xl md:text-4xl font-black text-cyan-400 mb-2">0,5 Sek</div>
            <div className="text-sm text-gray-400">Scan-Zeit</div>
          </div>
          <div className="text-center">
            <div className="text-3xl md:text-4xl font-black text-cyan-400 mb-2">100%</div>
            <div className="text-sm text-gray-400">Made in Germany</div>
          </div>
        </div>
